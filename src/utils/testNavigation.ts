...
export const createMockNavigation = <Screen extends keyof RootStackParamList>(
...
export const createMockRoute = <Screen extends keyof RootStackParamList>(
  name: Screen,
  params: RootStackParamList[Screen],
): RouteProp<RootStackParamList, Screen> => {
  return { key: name, name, params } as unknown as RouteProp<
    RootStackParamList,
    Screen
  >
}
